...
class CreateVendorRegisteredAddressTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('vendor_registered_address', function (Blueprint $table) {
    ...
    {
        Schema::drop('vendor_registered_address');
