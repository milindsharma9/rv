...
<div class="row">
    <div class="col-sm-10 col-sm-offset-2">
        <h1>{{ trans('admin/events.create-add_new') }}</h1>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::select('parent_id', $primaryEvents, null, array('class' => 'form-control')) !!}
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    {!! Form::label('image', 'Image (Preferred Size : 400 * 400)', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::file('image') !!}
