...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::select('user_type', config('cms.user_type'), $cms->user_type, ['class' => 'form-control']) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('title', old('title', $cms->title), ['class' => 'form-control', 'disabled' => true]) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('url_path', old('url_path', $cms->url_path), ['class' => 'form-control']) !!}
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-sm-10">        
        {!! Form::checkbox('published', '1', $cms->published, ['class' => '']) !!}
    </div>
</div>
