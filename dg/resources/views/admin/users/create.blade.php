...
{!! Form::open(array( 'route' => 'admin.users.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('companyname', old('companyname'), ['class' => 'form-control']) !!}
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-sm-10">        
        {!! Form::checkbox('activated', '1', 1, ['class' => '']) !!}
    </div>
</div>

<div class="form-group">
    <div class="col-sm-10 col-sm-offset-2">
      {!! Form::submit(trans('admin/users.add'), array('class' => 'btn btn-primary')) !!}
