...
@section('content')
<h1>{{ trans('admin/vendors.manage_vendors_stores') }}</h1>
@if ($errors->any())
        ...
        <table class="table table-striped table-hover table-responsive datatable table_layout_fixed" id="datatable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ isset($row->salesData->total_order) ? $row->salesData->total_order : 0 }}</td>
                    <td>{{ isset($row->salesData->total_value) ? $row->salesData->total_value : 0.00  }}</td>
                    <td>{{ isset($row->salesData->avg_order) ? $row->salesData->avg_order : 0.00  }}</td>
